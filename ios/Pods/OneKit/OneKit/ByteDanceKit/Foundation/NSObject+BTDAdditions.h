...
/**
 ...
 @param sel The selector.
 @param wait If wait is YES, the method will wait until the job in the main thead is over. Otherwise, the method will not wait.
 @param ... The variadic parameter list. The param type should be same with the corresponding type defined in the selector. Otherwise some errors may happen.
 @return The result from the selector.
 Sample Code:
...
/**
 ...
 @param ... The variadic parameter list. The param type should be same with the  corresponding type defined in the selector. Otherwise some errors may happen.
 @param wait  If wait is YES, the current thread will wait until the job in the param thead is over. Otherwise, the method will not wait.
 @return The result from the selector.
 */
